...
<div style="text-align: center" class="circle"><img src="https://momorell.wordpress.com/wp-content/uploads/2025/02/miguel-olmedo-morell-foto-de-perfil-1.jpeg" style="box-shadow: 0px 0px 10px #888;" width="300" height="300"/></div>
...
My journey as **Technical Writer and Documentation Manager** began in 2022. It started in ERNI, where I created API documentation such as user manuals, release notes, internal documentation, etc., for a pharmaceutical client. After moving to Valladolid, I started working for Capitole Consulting on a fixed-term contract to create, sort, migrate and standardize the global documentation for the Workday department of a client in the security industry. Most recently, I joined Bystronic Software to cover a maternity leave. In this position, I have created software documentation following a DevOps approach, I have proofread the UI strings of upcoming developments, and managed the translation of all documents into thirteen languages.
